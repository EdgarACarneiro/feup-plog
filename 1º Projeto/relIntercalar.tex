...
\begin{minipage}{.35\textwidth}
	\centering
	\includegraphics[width=\textwidth]{self_empty_board.png}
...
\begin{minipage}{.35\textwidth}
	\centering
	\includegraphics[width=\textwidth]{fabrik_empty_board.png}
...
\begin{figure}[h!]
\begin{center}
	\includegraphics[height=6cm, width=6cm]{self_semi_board.png}
...
\begin{minipage}{.35\textwidth}
	\centering
	\includegraphics[width=\textwidth]{self_full_board.png}
...
\begin{minipage}{.35\textwidth}
	\centering
	\includegraphics[width=\textwidth]{fabrik_full_board.png}
