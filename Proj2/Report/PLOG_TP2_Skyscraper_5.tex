...
We model the presented puzzle as a Constraint Satisfaction Problem, therefore representing it by a set of domain variables, their domains, and a set of restrictions.
